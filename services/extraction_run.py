...
def mobile_run_payload(root, run, charge) -> dict:
    ...
    return {
        ...
        "final_purge_started_at": booth_payload["final_purge_started_at"],
        "final_purge_completed_at": booth_payload["final_purge_completed_at"],
        "final_purge_duration_minutes": booth_payload["final_purge_duration_minutes"],
