...
class AppFactorySmokeTest(unittest.TestCase):
    ...
    def test_core_routes_registered(self) -> None:
        ...
        self.assertIn("/journeys/material-genealogy", rules)
        self.assertIn("/journeys/material-genealogy/raw", rules)
        ...
        self.assertIn("/api/v1/summary/material-genealogy", rules)
        ...
        self.assertIn("/api/v1/material-lots/<lot_id>", rules)
        self.assertIn("/api/v1/material-lots/<lot_id>/journey", rules)
        self.assertIn("/api/v1/material-lots/<lot_id>/ancestry", rules)
        self.assertIn("/api/v1/material-lots/<lot_id>/descendants", rules)
        ...
        self.assertIn("/material-lots/<lot_id>/correct", rules)
        self.assertIn("/scan/lot/<tracking_id>", rules)
        self.assertIn("/scan/lot/<tracking_id>/charge", rules)
        ...
        self.assertIn("/lots/<lot_id>/charge", rules)
