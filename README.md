...
- **Journey actual revenue and variance** - material lots can now store actual revenue events, the Material Journey Viewer can record those actuals, and Journey Home / Genealogy Report roll actual revenue, actual margin, and projected-vs-actual variance into manager review surfaces.
...
- **Revenue capture in the Material Journey Viewer** - editors can record sold quantity, unit price, buyer/channel, reference, and notes against a material lot, preserving actual revenue as an auditable layer separate from planning assumptions.
