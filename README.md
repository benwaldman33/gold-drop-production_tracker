...
- **Reactor lifecycle controls** — Extractors can now move a charge through `In Reactor`, `Running`, `Completed`, or `Cancelled` directly from `Floor Ops`, and every state change is timestamped into audit history on the charge.
