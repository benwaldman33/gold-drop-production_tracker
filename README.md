...
- **Standalone Extraction Lab App** — `standalone-extraction-lab-app/` now mirrors the extractor workflow with a touch-first reactor board, chargeable lot browser, large charge controls, lifecycle actions, and a direct handoff into the main run form for full run editing.
